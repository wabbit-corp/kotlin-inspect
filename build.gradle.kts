...
kover {
    ...
    //             // title.set("kotlin-inspect Code Coverage") // Uncomment to customize title
    //         }
    //         xml {
...
dokka {
    ...
    dokkaSourceSets.main {
        ...
        sourceLink {
            ...
            remoteUrl("https://github.com/wabbit-corp/kotlin-inspect/tree/master/src/main/kotlin")
